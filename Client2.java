		...
		try
		{
			...
			while(true)
			{
				...
				//receive file packets and save to a new file
					...
					//Packet receiving logic (Out-of-order and loss prevention)	
					//for(int i = 0; i < numPackets; i++)
					while(packetsReceived < numPackets)
					{
						//create new customPacket to store received data
						...
						if(receivedArray[customPacket.getId()] == 0)
						{
							receivedArray[customPacket.getId()] = 1;
							packetsReceived++;
